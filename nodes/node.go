...
type Node struct {
	...
	NodeDescription string `json:"node_desc,omitempty"`      // Optional description of the node
	DeviceId        string `json:"deviceId,omitempty"`       // Associated device ID, if any
	NodeProjectId   string `json:"nodeprojectid,omitempty"`  // Project ID this node belongs to
